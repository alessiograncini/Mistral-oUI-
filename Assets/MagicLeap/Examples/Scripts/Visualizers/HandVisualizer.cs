...
#pragma warning restore 414
        ...
        private Transform _center = null;
         [SerializeField]
        private Transform _thumbOut= null;
        [SerializeField]
        private Transform _indexOut= null;
        ...
        void Update()
        {
            ...
            for (int i = 0; i < this._indexFingerBones.Count; ++i)
            {
                ...
                this._indexFinger[i].gameObject.SetActive(highConfidence && HandTracking.GetKeyPointStatus(this.handDevice, HandTracking.KeyPointLocation.Index, i));
                            ...
                            _indexOut.localPosition= _indexFinger[0].localPosition; //bonePosition;
                _indexOut.localRotation = _indexFinger[0].localRotation;
            ...
            for (int i = 0; i < this._thumbBones.Count; ++i)
            {
               ...
               _thumbOut.localPosition = _thumb[0].localPosition;
                _thumbOut.localRotation = _thumb[0].localRotation;
