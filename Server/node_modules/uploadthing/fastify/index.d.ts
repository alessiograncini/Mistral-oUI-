 ...
 */
declare const fastifyUploadthingPlugin: <TRouter extends FileRouter>(fastify: FastifyInstance, opts: RouteHandlerOptions<TRouter>, done: (err?: Error) => void) => void;

export { createRouteHandler, createUploadthing, fastifyUploadthingPlugin };
