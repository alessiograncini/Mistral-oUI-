...
declare const createRouteHandler: <TRouter extends FileRouter>(opts: RouteHandlerOptions<TRouter>) => h3.EventHandler<h3.EventHandlerRequest, Promise<unknown>>;
/**
 * @deprecated Use {@link createRouteHandler} instead
 */
declare const createH3EventHandler: <TRouter extends FileRouter>(opts: RouteHandlerOptions<TRouter>) => h3.EventHandler<h3.EventHandlerRequest, Promise<unknown>>;
