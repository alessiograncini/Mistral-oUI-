...
const createRouteHandler = (opts)=>{
    ...
    return h3.defineEventHandler(async (event)=>{
        h3.assertMethod(event, [
            "GET",
            "POST"
        ]);
        h3.setHeader(event, "x-uploadthing-version", version);
        // GET
        if (event.method === "GET") {
        ...
        if (response instanceof shared.UploadThingError) {
            h3.setResponseStatus(event, shared.getStatusCodeFromError(response));
...
exports.createH3EventHandler = createH3EventHandler;
